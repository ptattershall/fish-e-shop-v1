export const products = [
    {
      ...
      images: [
        {
          color: "White",
          id: "64a654593e91b8e73a351e9b.White",
          colorCode: "#FFFFFF",
          quantity: 10,
          image:
        ...
        {
          color: "Gray",
          id: "64a654593e91b8e73a351e9b.Gray",
          colorCode: "#808080",
          quantity: 10,
          image:
    ...
    },
    {
      ...
      images: [
        {
          color: "Black",
          id: "64a4ebe300900d44bb50628a.Black",
          colorCode: "#000000",
          quantity: 10,
          image:
    ...
    },
    {
      ...
      images: [
        {
          color: "Black",
          id: "648437b38c44d52b9542e340.Black",
          colorCode: "#000000",
          quantity: 10,
          image:
        ...
        {
          color: "Blue",
          id: "648437b38c44d52b9542e340.Blue",
          colorCode: " #0000FF",
          quantity: 10,
          image:
        ...
        {
          color: "Red",
          id: "648437b38c44d52b9542e340.Red",
          colorCode: "#FF0000",
          quantity: 10,
          image:
    ...
    },
    {
      ...
      images: [
        {
          color: "Graphite",
          id: "64a4e9e77e7299078334019f.Graphite",
          colorCode: " #383838",
          quantity: 10,
          image:
    ...
    },
    {
      ...
      images: [
        {
          color: "Black",
          id: "649d775128b6744f0f497040.Black",
          colorCode: "#000000",
          quantity: 10,
          image:
        ...
        {
          color: "Silver",
          id: "649d775128b6744f0f497040.Silver",
          colorCode: "#C0C0C0",
          quantity: 10,
          image:
